...
class User(db.Model, UserMixin):
    ...
    :param email: string
    :param name: string
    :param is_active: boolean, default false
    ...
    is_authenticated: Mapped[bool] = mapped_column(db.Boolean(), default=False)
    is_active: Mapped[bool] = mapped_column(db.Boolean(), default=False)
    is_anonymous: Mapped[bool] = mapped_column(db.Boolean(), default=False)
